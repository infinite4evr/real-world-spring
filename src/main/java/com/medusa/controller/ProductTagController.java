...
public class ProductTagController {
    ...
    final private ProductTagService service;
    ...
    @PostMapping("")
    @HandleInvalidBody
    public ResponseEntity<Object> createCategory(@Valid @RequestBody ProductTagDTO productTagDTO) throws Exception {
    ...
    @HandleInvalidBody
    public ResponseEntity<Object> updateProductTag(@PathVariable @Positive Long productTagId, @RequestBody Map<String, Object> updates) {
