package com.medusa.annotations.HandleInvalidBody;
...
public class HandleInvalidBodyValidator {
    ...
    public ResponseEntity<Object> handleInvalidBody(MethodArgumentNotValidException ex, HandlerMethod handlerMethod) {
